...
class App
{
    ...
    public function __construct()
    {
         ...
         */
        define('APP_HOST'       , $_SERVER['HTTP_HOST'] . "/agenda_mm");
        define('PATH'           , realpath('./'));
        define('TITLE'          , "Agenda de Contatos MadeiraMadeira");
        define('DB_HOST'        , "localhost");
        define('DB_USER'        , "root");
        define('DB_PASSWORD'    , "1234");
        define('DB_NAME'        , "agenda_mm");
    ...
    public function run()
    {
        ...
        if (method_exists($objetoController, $this->action)) {
            ...
            throw new Exception("A página não pode ser exibida.", 500);
        }
        throw new Exception("Página não encontrada.", 404);
    }
